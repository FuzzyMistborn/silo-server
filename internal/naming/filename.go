...
var (
	...
	// seasonEpisodeRe matches S01E01, s01e05, or separator-delimited variants
	// such as s01.e05 (a dotted namer style) and s01_e05.
	seasonEpisodeRe = regexp.MustCompile(`(?i)[Ss](\d{1,4})[._\- ]?[Ee](\d{1,3})`)
